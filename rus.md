...
Используя описанные выше строгие шаблоны в HTML, мы сможем сделать многое. Первое, и самое очевидное, мы сможем писать гораздо более выразительный и осмысленный код, в результате чего коллегам будет гораздо легче ориентироваться в проекте. И они тоже могут внести в это свой вклад.
...
Итак, у нас есть парочка простых расширений БЭМ, которые превращают его в BEMIT: мы добавляем информацию в начало и конец стандартных классов Блока, Элемента и Модификатора, что бы дать информацию о том, как эти классы ведут себя вне контекста связей между ними. Ещё немного примеров:
