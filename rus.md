...
Используя описанные выше строгие и последовательные правила описания нашего HTML, мы можем сделать многое. Первое, и самое очевидное, мы сможем писать гораздо более выразительный и осмысленный код, в результате чего нашим коллегам будет гораздо легче ориентироваться в проекте, и дорабатывая код, согласно этим правилам, они будут повышать его дальнейшее качество.

Ещё одним приятным бонусом является то, что мы можем визуально оценить жизнеспособность нашего кода. Используя селекторы по подстроке значения атрибута, мы можем визуализировать структуру страницы используя классы, из которых она состоит:
