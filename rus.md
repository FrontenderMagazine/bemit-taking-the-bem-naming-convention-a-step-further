...
какую задачу должен выполнять каждый класс, как и где мы cможем (или нет) использовать его повторно или модифицировать — и многое другое. Статья довольно большая, но она позволит вам значительно лучше понять этот подход.
...
Используя описанные выше строгие шаблоны в HTML, мы можем сделать многое. Первое, и самое очевидное, мы сможем писать гораздо более выразительный и осмысленный код, в результате чего нашим коллегам будет гораздо легче ориентироваться в проекте, и дорабатывая код, согласно этим правилам, они будут повышать его дальнейшее качество.
...
Итак, у нас есть пара простых расширений БЭМ, которые превращают его в BEMIT: мы добавляем информацию в начало и конец стандартных классов Блока, Элемента и Модификатора, что бы дать информацию о том, как эти классы ведут себя вне контекста связей между ними. Вот ещё немного примеров:
